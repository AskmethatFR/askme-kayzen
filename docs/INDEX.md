...
| `adr-0006-cqrs-light` | CQRS-light read side: query use cases + per-screen DTOs as crate-boundary contract, reads via existing ports, all derived data computed on read (stats = more queries), no projections/read store | current | 2026-07-22 | `[[architecture-overview]]`, `[[adr-0005-progression-suggestion-policy]]`, `[[adr-0003-two-crate-workspace]]`, `[[habit-progression-study]]` | `docs/technical/adr/0006-cqrs-light.md` |
...
| ID | Title | Status | Updated | Links | Path |
|---|---|---|---|---|---|
| `lifecycle-backlog` | Habit Lifecycle — approved model (suggestion-not-mutation), Q1–Q5 decisions (conservative thresholds), 8-slice backlog incl. stats-board, per-slice aggregate growth, slices 1-2 done | current | 2026-07-22 | `[[feature-catalog]]`, `[[glossary]]`, `[[design-principes-kaizen]]`, `[[design-gestes-kaizen]]`, `[[architecture-overview]]`, `[[habit-progression-study]]`, `[[adr-0006-cqrs-light]]`, `[[adr-0007-habit-lifecycle-aggregate]]` | `docs/functional/lifecycle-backlog.md` |
...
| `glossary` | Ubiquitous language — Habit, Habit Board, Title, Duplicate, HabitRequested, Completion, Completion history, Mark done, Local date, Clock, Outbox | current | 2026-07-22 | `[[feature-catalog]]` | `docs/functional/glossary.md` |
