...
| `adr-0009-quality-gates` | Quality gates: spec-only Gherkin scenario gate, diff-scoped mutation testing, one runner (`scripts/check.sh`) — **draft, written by the orchestrator, awaiting Architect review** | draft | 2026-07-25 | `[[architecture-overview]]`, `[[adr-0003-two-crate-workspace]]`, `[[lifecycle-backlog]]`, `[[feature-catalog]]` | `docs/technical/adr/0009-quality-gates.md` |
