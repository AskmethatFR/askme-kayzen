...
| `adr-0009-quality-gates` | Quality gates: spec-only Gherkin scenario gate, diff-scoped mutation testing scoped to domain + use cases, one runner (`scripts/check.sh`) — **draft, written by the orchestrator, awaiting Architect review** | draft | 2026-07-26 | `[[architecture-overview]]`, `[[adr-0003-two-crate-workspace]]`, `[[lifecycle-backlog]]`, `[[feature-catalog]]` | `docs/technical/adr/0009-quality-gates.md` |
